...
final class Version20250420233457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE ingredient (id SERIAL NOT NULL, category_id INT DEFAULT NULL, minerals_id INT NOT NULL, nutritionals_id INT NOT NULL, vitamines_id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE ingredient_vitamines (id SERIAL NOT NULL, vitamine_A NUMERIC(10, 2) DEFAULT NULL, beta_carotene NUMERIC(10, 2) DEFAULT NULL, vitamine_D NUMERIC(10, 2) DEFAULT NULL, vitamine_E NUMERIC(10, 2) DEFAULT NULL, vitamine_K1 NUMERIC(10, 2) DEFAULT NULL, vitamine_K2 NUMERIC(10, 2) DEFAULT NULL, vitamine_C NUMERIC(10, 2) DEFAULT NULL, vitamine_B1 NUMERIC(10, 2) DEFAULT NULL, vitamine_B2 NUMERIC(10, 2) DEFAULT NULL, vitamine_B3 NUMERIC(10, 2) DEFAULT NULL, vitamine_B5 NUMERIC(10, 2) DEFAULT NULL, vitamine_B6 NUMERIC(10, 2) DEFAULT NULL, vitamine_B9 NUMERIC(10, 2) DEFAULT NULL, vitamine_B12 NUMERIC(10, 2) DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
